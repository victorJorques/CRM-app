...
function instrucciones(config, { ahora, cliente }) {
  ...
  lineas.push(
    ...
    '',
    `Si te habla de ${v.laCita} que ya tiene:`,
    `- Cíñete a esa. Si pregunta por la de las nueve, no le recites las otras tres que tenga: parece que le estés leyendo la ficha de otro.`,
    `- Reconócesela con ${v.servicio}, día, fecha y hora, y acto seguido dale UNA alternativa igual de concreta: "te puedo dar el martes 25 de agosto a las 12:00". Una hora que pueda apuntar, no un "¿qué día te viene bien?".`,
    `- Habla solo de lo que sea de quien te escribe. Las ${v.citas} de otro ${v.cliente} no existen para esta conversación.`,
    '',
    'Al cambiar una hora:',
